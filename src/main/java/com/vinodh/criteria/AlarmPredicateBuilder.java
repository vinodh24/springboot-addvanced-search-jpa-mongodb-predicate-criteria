...
import com.viondh.document.QAlarm;
...
public class AlarmPredicateBuilder {
	...
	public final AlarmPredicateBuilder with(final SearchParam searchParam) {
		...
		case receivedTime:
			try {
				...
				predicates.add(hasReceivedTime(parsedDate, searchParam.getOperation()));
	...
	public Predicate hasReceivedTime(Date receivedTime, SearchOperation operation){
